...
syntax match Special /\(^\|\s\)\(control\|action\|table\|counter\|header_type\|header\|register\|parser\|metadata\|field_list\|field_list_calculation\|primitive_action\|meter\|parse_error\|default\)\s/
syntax match Title /\(^\|\s\)\(reads\|actions\|input\|algorithm\|output_width\|min_size\|max_size\|size\|support_timeout\|action_profile\)/
